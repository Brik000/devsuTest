...
public class ReporteController implements IReporteController {
    ...
    public ResponseEntity<String> generarReporte(
        ...
        try {
            ...
            return ResponseEntity.ok("La solicitud para generar el reporte se ha enviado correctamente. En unos minutos lo podrá descargar.");
        } catch (ClienteNoExisteException | RangoFechasInvalidoException e) {
